...
![main window screenshot](spedit_ua.png)
...
У вікні інструментів виберіть основний і додатковий колір, виберіть інструмент для малювання мишею та змініть розмір пера. Наразі доступно для малювання Олівець, Лінія, Прямокутник, Заповнений прямокутник, Колоб Гумка та Піпетка.
...
Щоб обрати зразок кольору з зображення, скористайтесь інструментом Піпетка (колір визначається з активного шару).
