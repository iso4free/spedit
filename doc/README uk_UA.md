...
ВСТУП
=====
Програма написана за допомогою інструментів CodeTyphon IDE/Free Pascal. Простий, але (можливо) потужний редактор і бібліотечний менеджер спрайтів для 2D-ігор що, використовують графіку в стилі піксель-арт.
