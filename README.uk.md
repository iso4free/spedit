...
Програма написана за допомогою інструментів Lazarus IDE/Free Pascal compiler. Простий, але (можливо) потужний редактор і бібліотечний менеджер спрайтів для 2D-ігор що, використовують графіку в стилі піксель-арт.
