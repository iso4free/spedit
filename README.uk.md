...
У вікні інструментів виберіть основний і додатковий колір, виберіть інструмент для малювання мишею та змініть розмір пера. Наразі доступно для малювання Олівець, Лінія, Прямокутник, Заповнений прямокутник, Коло, Заливка області, Гумка та Піпетка.

Можна обрати основний і допоміжний кольори, клацнувши будь-який колір у палітрі лівою або Ctrl+ліва кнопка миші.

Натисніть Ctrl і клікніть правою кнопкою мишки щоб швидко обрати колір з зображення, яке малюєте.
