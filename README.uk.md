...
У вікні інструментів виберіть основний і додатковий колір, виберіть інструмент для малювання мишею та змініть розмір пера. Наразі доступно для малювання Олівець (швидка клавіша 'P'), Лінія (швидка клавіша 'L'), Прямокутник (швидка клавіша 'R'), Заповнений прямокутник (швидкі клавіші 'Shift+R'), Коло (швидка клавіша 'C'), Заливка області (швидка клавіша 'F'), Гумка (швидка клавіша 'E') та Піпетка (швидка клавіша 'O').

Для збільшення/зменшення розміру олівці використовуйте швидкі клавіші Ctrl+NumPlus/Ctrl+NumMinus відповідно.

Можна обрати основний і допоміжний кольори, клацнувши будь-який колір у палітрі лівою або Ctrl+ліва кнопка миші.

Натисніть Ctrl і клікніть лівою кнопкою мишки щоб швидко обрати колір з зображення, яке малюєте або скористайтесь інструментом Піпетка (швидка клавіша 'O').

Також можна вибрати будь-який колір, просто клацнувши на основному або додатковому кольорі лівою кнопкою миші для виклику Діалогу вибору кольору, або встановити як прозорий, клацнувши правою кнопкою миші.
...
Для тих, кому подобається мінімалістичний інтерфейс і використовує масимальну площу екрану для малювання, є опція переключення в повноекранний режим (клавіша <F11>), також можна приховати додаткові панелі - шари, фрейми, палітру з попереднім переглядом використовуючи відповідні кнопки на панелі інструментів.
...
- [ ] В ОС Windows інтерфейс працює некоректно
